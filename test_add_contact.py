...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.click_add_new_contact(wd)
        self.filling_out_the_form_contact(wd, Contact(firstname="Anton", lastname="Ivanov", nickname="fddsfsfds",
                                                      company="Google", address="www.Leningrad", mobile="+7123456789",
                                                      email="dsfdshiu@gmail.com"))
        self.click_submit(wd)
        self.logout(wd)

    def logout(self, wd):
        wd.find_element_by_link_text("Logout").click()

    def click_submit(self, wd):
        wd.find_element_by_name("submit").click()

    def filling_out_the_form_contact(self, wd, Contact):
    ...
    def click_add_new_contact(self, wd):
