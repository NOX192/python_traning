...
class TestAddGroup(unittest.TestCase):
    ...
    def test_add_group(self):
        ...
        self.init_group_creationinit_group_creation(wd)
        self.fill_group_form(wd, Group(name="dsadsadas", header="dsadsad", footer="dsadsada"))
    ...
    def init_group_creationinit_group_creation(self, wd):
